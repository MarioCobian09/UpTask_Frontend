...
// Recibe varias clases como argumentos, elimina valores falsy (false, null, "", etc.) y devuelve un string con las clases unidas por espacios.
function classNames(...classes: string[]) {
  return classes.filter(Boolean).join(" "); // elimina valores falsy
}
